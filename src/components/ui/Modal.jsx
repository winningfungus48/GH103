 ...
 *   </Modal>
 */
export default function Modal({ open, onClose, title, children, buttons, className = '', style = {} }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'rgba(0,0,0,0.5)', zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', ...style
      }}
      aria-modal="true"
      role="dialog"
      tabIndex={-1}
    ...
    >
      <div
        ...
        ref={modalRef}
        style={{ background: '#fff', borderRadius: 12, minWidth: 320, maxWidth: 420, width: '90vw', boxShadow: '0 8px 32px rgba(0,0,0,0.18)', outline: 'none', ...style }}
        tabIndex={0}
      >
        {title && <h2 style={{ margin: '0 0 1rem 0', fontSize: '1.5rem' }}>{title}</h2>}
        <div>{children}</div>
