  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '2rem', padding: '1rem', border: '1px solid #ccc' }}>
        ...
        />
        <p><strong>Input:</strong> {searchInput}</p>
        <p><strong>Debounced:</strong> {debouncedSearch}</p>
      </div>
      ...
      <div style={{ marginBottom: '2rem', padding: '1rem', border: '1px solid #ccc' }}>
        ...
        <p><strong>Scroll Position:</strong> {scrollPosition}</p>
        <p><strong>Throttled:</strong> {throttledScroll}</p>
      </div>
      ...
      <div style={{ marginBottom: '2rem', padding: '1rem', border: '1px solid #ccc' }}>
        ...
        <p><strong>Status:</strong> {isIntervalRunning ? 'Running' : 'Paused'}</p>
      </div>
    </div>
  );
};
